...
public class EastGreenState implements StreetLightsStateI {
    ...
    public boolean addVehicalsToNorth(int numVehicals) {
        Logger.writeMessage("Entering a addVehicalsToNorth() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        ...
        Logger.writeMessage("Leaving a addVehicalsToNorth() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        return false;
    ...
    public boolean addVehicalsToSouth(int numVehicals) {
        Logger.writeMessage("Entering a addVehicalsToSouth() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        ...
        Logger.writeMessage("Leaving a addVehicalsToSouth() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
    ...
    public boolean addVehicalsToEast(int numVehicals) {
        Logger.writeMessage("Entering a addVehicalsToEast() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        ...
        Logger.writeMessage("Leaving a addVehicalsToEast() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
    ...
    public boolean addVehicalsToWest(int numVehicals) {
        Logger.writeMessage("Entering a addVehicalsToWest() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        ...
        Logger.writeMessage("Leaving a addVehicalsToWest() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
    ...
    public void passVehicals() {
        Logger.writeMessage("Entering a passVehicals() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
        ...
        if (numVehicals > 0) {
            ...
            streetLightsContext.setNumVehicalsEast(numVehicals);
            results.storeNewResult(vehicalPassedThisCall + " vehical(s) passed from east.");
        ...
        Logger.writeMessage("Leaving a passVehicals() method of EastGreenState Class", Logger.DebugLevel.EAST_GREEN_STATE);
